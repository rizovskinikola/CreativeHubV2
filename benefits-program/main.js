window.cfields = {"7":"company_name","27":"number_of_employees","28":"package_type","8":"your_message"};
   ...
   (function() {
	 ...
	 var _removed = false;
	 var form_to_submit = document.getElementById('form_344');
	 ...
	 var form_submit = function(e) {
	   ...
	   if (validate_form()) {
		 ...
		 document.querySelector('#_form_344_submit').disabled = true;
			   var serialized = form_serialize(document.getElementById('_form_344')).replace(/%0A/g, '\\n');
   ...
   (function() {
	 ...
	 var _removed = false;
	 var form_to_submit = document.getElementById('form_346');
	 var allInputs = form_to_submit.querySelectorAll('input, select, textarea'), tooltips = [], submitted = false;
	 ...
	 var form_submit = function(e) {
	   ...
	   if (validate_form()) {
		 // use this trick to get the submit button & disable it using plain javascript
		 document.querySelector('#_form_346_submit').disabled = true;
			   var serialized = form_serialize(document.getElementById('_form_346')).replace(/%0A/g, '\\n');
		 var err = form_to_submit.querySelector('._form_error');
		 err ? err.parentNode.removeChild(err) : false;
		 _load_script('https://akoskarova.activehosted.com/proc.php?' + serialized + '&jsonp=true');
	   }
