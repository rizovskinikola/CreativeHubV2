...
<head>
    ...
    < title > HR Free Course < /title> < script >
        ...
        <div class="page-header order-1 order-lg-1">
            ...
            <div class="col-lg-6">
                ...
                <p class="text-left page-description">
                    Стартувај со бесплатен воведен курс во човечки ресурси и доколку си задоволен продолжи со целосната
                    програма на Aкадемија за човечки ресурси на Creative Hub.

                </p>
                <h4>Почеток: 12 септември</h4>
                <h4>Времетраење: 2 часа</h4>
            </div>
        </div>
                ...
                <div class="cards">
                    <div class="cards-inner">
                        ...
                        <p>
                            ...
                            слушнат примери од вистински искуства и ќе се мотивираат самите да навлезат
                            во материјалот.
                    ...
                    <div class="cards-inner">
                        ...
                        <div class="card-ul">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="item-text">Кариерниот пат на еден менаџер по човечки ресурси</div>
                            </div>
                            <div class="d-flex align-items-center mb-3">
                                <div class="item-number">02</div>
                                <div class="item-text">Вештините кои треба да ги поседува еден менаџер на човечки ресурси</div>
                            </div>
                            <div class="d-flex align-items-center mb-3">
                                <div class="item-number">03</div>
                                <div class="item-text">Анализа на job description од областа на човечки ресурси</div>
                            </div>
                            <div class="d-flex align-items-center mb-3">
                                <div class="item-number">04</div>
                                <div class="item-text">Основи на coaching</div>
                            </div>
                            <div class="d-flex align-items-center mb-3">
                                <div class="item-number">05</div>
                                <div class="item-text">Пример за поставување на процес на
performance management</div>
                            </div>
                            <div class="d-flex align-items-center mb-3">
                                <div class="item-number">06</div>
                                <div class="item-text">Техники за подобрување на лидерство
помеѓу вработените</div>
                            </div>
                        </div>

                        <div class="lecturer-card d-flex flex-column flex-lg-row">
                            <div>
                            <img class="d-none d-lg-block" src="images/mentor-arijana.png"
                                    alt="Creativehub Lecturer">
                                <img class="d-lg-none img-fluid mb-3" src="images/mentor-arijana-mobile.png"
                                    alt="Creativehub Lecturer">
                            </div>
                            <div class="lecturer-card-text ms-3">
                                Предавач: <b>Аријана Коскарова</b>
                                <br><br>
                                Маркетинг директор и ко-основач на Creative Hub, член на Forbes Business Council, менаџер на Creative Hub Miami. 
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="how-to-start-wrapper">
                    ...
                    <div class="hts-element">
                        ...
                        <p>2. Чекај повик од нашиот координатор кој ќе ја потврди твојата апликација</p>
                    </div>
                    <div class="hts-element">
                        <div class="text-center"><img src="Images/how-to-start3.svg" alt="Register"></div>
                        <p>3.Добиј целосен распоред за предавањата и започни со воведниот курс</p>
                    </div>
                </div>
                ...
                <div class="cards-purple">
                    <div class="cards-inner-purple">
                        ...
                        <p class="grey-text">
                            ...
                            човечки ресурси пред да се одлучиш за кариерно насочување.
                        </p>
                    </div>
                </div>
                ...
                <div class="cards-purple-1">
                    <div class="cards-inner-purple">
                        ...
                        <p class="grey-text">
                            ...
                            Научи ги сите алатки и принципи на човечки ресурси.
                        </p>
                ...
                <div class="p-2">
                    ...
                    <div class="accordion-item">
                        <div class="accordion-item-inner">
                            <button class="accordion position-relative">
                                <div class="pe-4">Кога ќе се одржи курсот?
                                </div>
                            </button>
                            <div class="panel">
                                <br>
                                <p class="m-0">
                                Курсот ќе се одржи на 12 септември 18:00-20:00 часот.
Курсот ќе биде онлајн во живо.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="accordion-item-inner">
                            ...
                            <div class="panel">
                                ...
                                <p class="m-0">
                                    ...
                                    тоа дали ќе изберете Само Академија ( 1399 ЕУР) , ЕУ Сертифицирана ( 1699 ЕУР)
                                    или Fast-track Академија (3099 ЕУР) што вклучува +88 часови и 1-на-1 менторски
