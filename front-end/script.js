...
$(document).ready(function () {
  ...
  const employmentAcc = document.getElementsByClassName("employment-accordion");

  const toggleEmploymentAccordion = (accordion) => {
    accordion.classList.toggle("active");
    accordion.children[0].classList.toggle("employment-active-item")
    accordion.children[0].classList.toggle("employment-item")
  ...
  for (let i = 0; i < employmentAcc.length; i++) {
    if (i === 0) toggleEmploymentAccordion(employmentAcc[0]);
    employmentAcc[i].addEventListener("click", () => toggleEmploymentAccordion(employmentAcc[i]));
  }
...
(function () {
  ...
  var _removed = false;
  var form_to_submit = document.getElementById('_form_296_');
  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      ...
      document.querySelector('#_form_296_submit').disabled = true;
      var serialized = _form_serialize(document.getElementById('_form_296_')).replace(/%0A/g, '\\n');
