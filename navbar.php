...
document.addEventListener("DOMContentLoaded", function() {
    ...
    } else if (url.search('hakatoni') > -1) {
        document.getElementById('careersDropdown').classList.add('active-blue-color')
        document.getElementById('HakanotnsItem').classList.add('active-menu-item')
        document.getElementById('HakatonsFooterItem').classList.add('active-footer-item')
    }
});
</script>
            ...
            <nav class="navbar navbar-expand-lg p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" id="careersDropdown"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Кариера
                            </a>
                            <div class="dropdown-menu" aria-labelledby="careersDropdown">
                                ...
                                <a class="dropdown-item" href="<?php echo SITE_URL; ?>hakatoni" id="HakanotnsItem">
                                    Хакатони
                                </a>
                                <a class="dropdown-item" href="<?php echo SITE_URL; ?>ux-ui-quests" id="ux/uxQuests">
                                    UX/UI Quests
                                </a>
                        ...
                        <li class="nav-item">
                                <a class="nav-link" href="<?php echo SITE_URL; ?>benefits-program">
                                Фонд на знаење
                                    </a>
                                </li>
                    </ul>
...
<header class="header-mobile-navbar d-lg-none">
    <div id="mainMobileMenu" class="overlay">
        ...
        <div class="overlay-content container">
            ...
            <div class="mobile-menu-item">
                        <a href="<?php echo SITE_URL; ?>benefits-program" style="color:inherit"> Фонд на знаење   </a>
                        </div>
                        <div class="mobile-menu-item">
                        <a href="<?php echo SITE_URL; ?>HiringPlatform" style="color:inherit"> Платформа за вработување    </a>
                        </div>
            <hr class="navbar-hr">
    ...
    <div id="academiesMenu">
        ...
        <div class="container d-flex flex-column pt-4">
            ...
            <a class="mobile-submenu-item" href="<?php echo SITE_URL; ?>power-bi">
                <div class="d-flex justify-content-between align-items-center">
                    Power BI
                    <img src="../images-navbar/menu_right_arrow.png">
                </div>
