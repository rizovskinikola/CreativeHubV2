        ...
        <div class="container d-flex flex-wrap justify-content-between">
            <div class="footer-logo-section pe-2 pe-lg-0 d-flex flex-column justify-content-between">
                <div>
                    ...
                    <p class="mb-0 mt-3">Стекни знаење, поврзи се и најди ја твојата идеална кариерна насока.</p>
                </div>
            ...
            <div class="footer-menu mb-3 mb-lg-0">
                ...
                <a href="<?php echo SITE_URL; ?>graphic-design">
            ...
            <div>
                ...
                <a href="mailto: contact@creativehub.com">
                    <div class="footer-menu-item py-2 px-lg-2">contact@creativehub.mk</div>
                </a>
                <a href="tel:0038970927756">
                    <div class="footer-menu-item py-2 px-lg-2">+389 70 927 756</div>
                </a>
                <a href="tel:0038972305582">
                    <div class="footer-menu-item py-2 px-lg-2">+389 72 305 582</div>
                </a>
            </div>
        </div>
