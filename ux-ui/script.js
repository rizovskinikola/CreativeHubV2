...
$(document).ready(function () {
  $("#nikolaMentorModal").on('hidden.bs.modal', function (e) {
    $("#firstProjectModal iframe").attr("src", $("#firstProjectModal iframe").attr("src"));
  });
  $("#sasheMentorModal").on('hidden.bs.modal', function (e) {
    $("#secondProjectModal iframe").attr("src", $("#secondProjectModal iframe").attr("src"));
  });
...
(function () {
  ...
  var _removed = false;
  var form_to_submit = document.getElementById('_form_294_');
  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      ...
      document.querySelector('#_form_294_submit').disabled = true;
      var serialized = _form_serialize(document.getElementById('_form_294_')).replace(/%0A/g, '\\n');
